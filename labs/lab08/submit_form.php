	...
	<div class="container">
		...
		<div class="row mt-3">
			<div>
				...
				<?php
					// print out when form was submitted
					date_default_timezone_set("America/Los_Angeles");
					echo "This form was submitted on " . date("l, F j, Y"). " at ". date("g:i:s T");
				?>
			</div>
		</div>
		...
		<div class="row mt-4">
			...
			<div class="col-8">
				<!-- PHP Output Here -->
				<?php
					// prints outfirst or last name if entered
			...
			<div class="col-8">
				...
				<?php
					...
					if($_POST["phone"] != $_POST["phone-confirm"]){
						echo '<div class ="text-danger">'. "Number's do not match". '</div>'; 
					}
					else {
						echo '<div class= "text-success">'. $_POST["phone"]. '</div>'; 
					}
				?>
			</div>
		</div> <!-- .row -->
		...
		<div class="row mt-3">
			...
			<div class="col-8">
				<!-- PHP Output Here -->
				<?php
					// prints out each flavor selected
